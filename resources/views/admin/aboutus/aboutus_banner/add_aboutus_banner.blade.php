 ...
 <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Add About Us Banner</h1>
                  <small>Add About Us Banners</small>
               </div>
            </section>
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              ...
                              <i class="fa fa-eye"></i>  View About Us Banner </a>  
                           </div>
                        </div>
                        <div class="panel-body">
                           <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-aboutus_banner')}}" method="post">
                                {{csrf_field()}}
