...
<head>
   ...
   <body class="hold-transition sidebar-mini">
      ...
      <script src="{{asset('admin_assets/dist/js/custom.js')}}" type="text/javascript"></script>
        ...
        <!-- Modal js -->
        <script src="{{asset('admin_assets/plugins/modals/classie.js.js')}}" type="text/javascript"></script>
      ...
      <script>
         $(document).ready( function () {
            ...
            //Update Latest Product Status
         $(".LatestProductStatus").change(function(){
            var id = $(this).attr('rel');
            if($(this).prop("checked")==true){
               $.ajax({
                  headers: {
                  ...
                  type : 'post',
                  url : '/admin/latest-product-status',
                  data : {latest_product:'1',id:id},
                  success:function(data){
                     $("#message_success").show();
                     setTimeout(function() { $("#message_success").fadeOut('slow'); }, 2000);
                  },error:function(){
            ...
            if($(this).prop("checked")==true){
               $.ajax({
                  ...
                  type : 'post',
                  url : '/admin/featured-product-status',
                  data : {featured_product:'1',id:id},
                  success:function(data){
                     $("#message_success").show();
                     setTimeout(function() { $("#message_success").fadeOut('slow'); }, 2000);
                  },error:function(){
            ...
            $(".LatestCategoryStatus").change(function(){
               var id = $(this).attr('rel');
                  if($(this).prop("checked")==true){
                     $.ajax({
                        headers: {
                        ...
                        type : 'post',
                        url : '/admin/latest-category-status',
                        data : {latest_category:'1',id:id},
                        success:function(data){
                           $("#message_success").show();
                           setTimeout(function() { $("#message_success").fadeOut('slow'); }, 2000);
                        },error:function(){
