    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="invoice-title text-center" style="margin-top: 10px;">
                <img src="{{asset('front_assets/images/home/logo.png')}}" class="logo">
    					...
    					<table class="table table-striped">
    						...
    						<tbody>
    							...
    							<tr>
                                    ...
                                    <td class="text-center">Rs {{$pro->product_price * $pro->product_qty }}</td>
                                </tr>
                               ...
                               @endforeach
                                ...
                                <td class="thick-line text-center">Rs {{$sub_total}}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
                                    <td class="no-line"></td>
