	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
                                @foreach($ProductsAltImages as $key=>$images)
	                                <div style="background-image: url({{asset('/uploads/products/'.$images->image)}});" class="item-box"></div>
                                @endforeach
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
                                @foreach($ProductsAltImages as $key=>$images)
	                                <div style="background-image: url({{asset('/uploads/products/'.$images->image)}});" class="item active"></div>
                               @endforeach
	                        </div>
                        ...
                        <form name="addtoCart" method="post" action="{{url('/add-cart')}}">{{csrf_field()}}
                            ...
                            <div class="prod_options">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-5 col-md-6 col-6">
                                        <div class="custom-select-form">
                                            <select class="wide">
                                                <option value="" selected>{{$productDetails->color}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-5 col-md-6 col-6">
                                        <div class="custom-select-form">
                                            <select class="wide" id="selSize" name="size">
                                            @foreach($productDetails->attributes as $sizes)
                                                <option value="{{$productDetails->id}}-{{$sizes->size}}" selected>{{$sizes->size}}</option>
                                            @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="price_main" id="getPrice"><span class="new_price">Rs. {{$productDetails->price}}</span></div>
                                </div>
                                ...
                                @else
                                    <div class="btn_add_to_cart"><a href="{{url('/login-register')}}" class="btn_1">Login</a></div>
                                @endif
                                    </div>
                            </div>
                        </form>
